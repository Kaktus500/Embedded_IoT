 ...
 * @file      Profile.h
 * @brief     Profiling
 * @details   Implement the profiling interface on the MSP432.  This
 ...
 *
 * @param  none
 * @return 7-bit status of all Profile pins
 *
 * @note   Profile_Init() has been called
 * @brief  status of all Profile pins
 */
