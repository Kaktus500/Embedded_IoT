/**
 * @file      BSP.h
 * @brief     Provide low-level functions that interface Educational BoosterPack MKII.
 * @details   Runs on either the TM4C123 or MSP432 with an Educational BoosterPack MKII (BOOSTXL-EDUMKII)
...
/*!
 * @defgroup MKII
 * @brief Educational BoosterPack MKII
 * @{*/
